...
package com.straw.lession.physical.custom.wheelview;
...
import com.straw.lession.physical.adapter.wheelview.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private void initResourcesIfNecessary() {
		...
		setBackgroundResource(wheelBackground);
		//setBackgroundResource(getResources().getColor(R.color.blue17));
	...
	private void drawCenterRect(Canvas canvas) {
		...
		//int offset = (int) (getItemHeight() / 2 * 1.2);  //leiupdate 20151218
