...
/**
 * A simple text label view that can be applied as a "badge" to any given {@link View}. This class is
...
public class BadgeView extends TextView {
	...
	private void applyTo(View target) {
		...
		if (target instanceof TabWidget) {
			...
			lp.width = (int)getResources().getDimension(R.dimen.dimen_40dp);
			group.addView(container, index, lp);
			FrameLayout.LayoutParams lptarget = new FrameLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT);
			lptarget.gravity = Gravity.CENTER_VERTICAL|Gravity.LEFT;
