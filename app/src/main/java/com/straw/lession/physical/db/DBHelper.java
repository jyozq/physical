...
public class DBHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS course_define" +
                "(_id INTEGER PRIMARY KEY AUTOINCREMENT, courseCode VARCHAR, courseType VARCHAR, " +
                "courseName VARCHAR, instituteId INTEGER, classId INTEGER, teacherId INTEGER, weekDay INTEGER," +
